...
import prestasi1Image from '@/assets/images/prestasi/prestasi1.avif'
import prestasi2Image from '@/assets/images/prestasi/prestasi2.avif'
import prestasi3Image from '@/assets/images/prestasi/prestasi3.avif'
import prestasi4Image from '@/assets/images/prestasi/prestasi4.avif'
import prestasi5Image from '@/assets/images/prestasi/prestasi5.avif'
import prestasi6Image from '@/assets/images/prestasi/prestasi6.avif'
import prestasi7Image from '@/assets/images/prestasi/prestasi7.avif'
import prestasi8Image from '@/assets/images/prestasi/prestasi8.avif'
import prestasi9Image from '@/assets/images/prestasi/prestasi9.avif'
import prestasi10Image from '@/assets/images/prestasi/prestasi10.avif'
import prestasi11Image from '@/assets/images/prestasi/prestasi11.avif'
import Sponsor1Image from '@/assets/images/sponsorship/Asuransi-jiwasraya.avif'
import Sponsor2Image from '@/assets/images/sponsorship/Bank-Nationalnobu.avif'
import Sponsor3Image from '@/assets/images/sponsorship/BRI.avif'
import Sponsor4Image from '@/assets/images/sponsorship/cbn.avif'
import Sponsor5Image from '@/assets/images/sponsorship/Charoen-Pokphand-Indonesia.avif'
import Sponsor6Image from '@/assets/images/sponsorship/interfreight.avif'
import Sponsor7Image from '@/assets/images/sponsorship/milo.avif'
import Sponsor8Image from '@/assets/images/sponsorship/pertamina.avif'
import Sponsor9Image from '@/assets/images/sponsorship/scoot.avif'
import Sponsor10Image from '@/assets/images/sponsorship/sentratimur.avif'
import Sponsor11Image from '@/assets/images/sponsorship/suthakarya.avif'
...
const achievements = ref([
  {
    title: 'Warrior Cup 2021',
    year: '2021',
    desc: 'Multiple gelar di berbagai kategori: KU 10 Peringkat 2, KU 12 Pa Peringkat 1, KU 14 Pa Peringkat 1, KU 16 PA Peringkat 1, KU 18 PA Peringkat 1',
    icon: `
  ...
  {
    title: 'Kejuaraan Perbasi DKI 2019',
    year: '2019',
    desc: 'Dominasi penuh dengan gelar di KU 12pi, KU 14pa, KU 16pi, KU 16pa, KU 18pa, dan runner up di beberapa kategori',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Kejurnas Nasional 2019',
    year: '2019',
    desc: 'Prestasi gemilang di tingkat nasional: KU 18pa Juara 2, KU 16pa Juara 1, KU 14pa Juara 1, KU 12pi Juara 1',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'YBA National Championship 2017',
    year: '2017',
    desc: 'KU 12 Putera Juara 2, KU 16 Puteri Juara 2, dan MVP U16 Puteri: Tricia',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'Kejurnas U14 2017',
    year: '2017',
    desc: 'KU 14 Putera Juara 1, KU 14 Puteri Juara 2, MVP Final game: Atysatya Prawira Adjas',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'APYBC Singapore 2017',
    year: '2017',
    desc: 'KU 13 Girls Juara 1, KU 15 Girls Juara 2, dan peringkat di berbagai kategori lainnya',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'Perbasi Jakarta Selatan 2020',
    year: '2020',
    desc: 'Dominasi penuh dengan juara 1 di hampir semua kategori: KU 12, 14, 16, 18 Putera dan Puteri',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'Multiple Tournament 2019',
    year: '2019',
    desc: 'Berbagai turnamen: 3 Generasi I & II, IM Cup, Cougar Cup, Asaba Cup, Jetz Tournament, GCBS Yogya, Tunas Bandung, YBA Cirebon',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'Perbasi Wilayah 2018',
    year: '2018',
    desc: 'Juara 1 KU 14 Putera, KU 14 Puteri, KU 16 Putera, KU 16 Puteri, KU 18 Puteri di Jakarta Selatan',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'NBC 3x3 & Turnamen 2016-2017',
    year: '2017',
    desc: 'Berbagai prestasi di Brotherhood, YBA Cup, SABC, 3 Generasi, Pokeba, Dekade, dan kompetisi PERBASI',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'Sparkle Cup 2014',
    year: '2014',
    desc: 'Juara 1 di KU 12 Puteri, KU 12 Putera, KU 14 Puteri, KU 14 Putera, dan Juara 3 KU 10 Mix',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
  ...
  {
    title: 'Konsistensi Prestasi 2010-2023',
    year: '2023',
    desc: 'Lebih dari 76 trofi dan ratusan prestasi dalam berbagai kejuaraan dari tingkat lokal hingga nasional sejak 2010',
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-piper-500" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1a7 7 0 0 0-7 7c0 2.5 1.3 4.7 3.3 6l-1.7 6.8a1 1 0 0 0 1.5 1.1L12 19.6l3.9 2.3a1 1 0 0 0 1.5-1.1l-1.7-6.8A7 7 0 0 0 19 8a7 7 0 0 0-7-7z"/>
      </svg>
...
const achievementPhotos = ref([
  {
    image: prestasi1Image,
    // title: 'Juara Nasional 2022',
    // desc: 'Tim U16 Boys meraih juara nasional di kompetisi tahun 2022'
  },
  {
    image: prestasi2Image,
    // title: 'Grand Champion DKI 2019',
    // desc: 'Dominasi penuh di kompetisi DKI Jakarta dengan multiple gelar'
  },
  {
    image: prestasi3Image,
    // title: '76 Trofi Tahun 2023',
    // desc: 'Pencapaian luar biasa dengan 76 trofi dalam berbagai kompetisi'
  },
  {
    image: prestasi4Image,
    // title: 'Juara Regional 2021',
    // desc: 'Kemenangan gemilang di kejuaraan regional Jakarta Selatan'
  },
  {
    image: prestasi5Image,
    // title: 'Turnamen Antarklub 2020',
    // desc: 'Penampilan solid di turnamen antarklub se-Jabodetabek'
  },
  {
    image: prestasi6Image,
    // title: 'Turnamen Antarklub 2020',
    // desc: 'Penampilan solid di turnamen antarklub se-Jabodetabek'
  },
  {
    image: prestasi7Image,
    // title: 'Turnamen Antarklub 2020',
    // desc: 'Penampilan solid di turnamen antarklub se-Jabodetabek'
  },
  {
    image: prestasi8Image,
    // title: 'Turnamen Antarklub 2020',
    // desc: 'Penampilan solid di turnamen antarklub se-Jabodetabek'
  },
  {
    image: prestasi9Image,
    // title: 'Turnamen Antarklub 2020',
    // desc: 'Penampilan solid di turnamen antarklub se-Jabodetabek'
  },
  {
    image: prestasi10Image,
    // title: 'Turnamen Antarklub 2020',
    // desc: 'Penampilan solid di turnamen antarklub se-Jabodetabek'
  },
  {
    image: prestasi11Image,
    // title: 'Turnamen Antarklub 2020',
    // desc: 'Penampilan solid di turnamen antarklub se-Jabodetabek'
  }
])
const sponsorships = ref([
  ...
  {
    name: 'Sentra Timur Residence',
    image: Sponsor10Image,
  },
  {
    name: 'Sutha Karya Steelindo',
    image: Sponsor11Image,
  }
])
</script>
<template>
  <Layouts>
    <!-- Section 1 -->
    <div>
      <div class="bg-piper-600 w-full h-16">
        <div class="h-full w-full flex md:justify-end justify-center items-center gap-3 px-10">
          <div class="flex gap-1 justify-center items-center">
            <svg class="fill-white w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg viewBox="0 0 24 24" class="fill-white w-5 h-5" xmlns="http://www.w3.org/2000/svg">
              <g id="SVGRepo_iconCarrier">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <svg class="fill-white w-5 h-5" viewBox="-5 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            <div class="flex bg-white border border-gray-400 shadow-lg rounded-lg overflow-hidden">
              <div class="flex items-center justify-center pl-2">
                <svg viewBox="0 0 24 24" class="w-5 stroke-gray-400" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g id="SVGRepo_iconCarrier">
                    <path
              ...
              <input class="bg-white text-black px-2 py-1 text-sm focus:outline-0" type="text" placeholder="Cari...." />
            </div>
          </div>
        </div>
      </div>
      <div class="bg-gray-500 h-[calc(100vh-128px)] relative z-10">
        <img :src="heroImage" alt="" class="absolute w-full h-full object-cover" />
        <div
      ...
      <div class="w-full grid md:grid-cols-2 grid-cols-1 gap-10 p-10 relative z-30 h-full">
        <div class="relative order-2 md:order-1">
          ...
          <div class="grid md:grid-cols-2 grid-rows-2 md:gap-10 gap-5 h-full relative z-20">
            <div v-for="(item, index) in coachesList" :key="index" class="relative z-30 group">
              ...
              }" preview class="!rounded-lg h-full w-full object-cover" :src="item.image" alt="">
                <template #preview>
                  <div class="px-3">
        ...
        <div class="order-1 md:order-2 flex justify-center flex-col h-full text-black">
          ...
          <p class="font-comicsans md:text-sm text-xs mt-5">
            ...
            serius, pelatih kami membantu setiap pemain menemukan potensi terbaiknya dan menjadikan
            basket sebagai bagian dari gaya hidup sehat dan inspiratif.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="w-full md:h-[calc(100vh-64px)] bg-gray-100 relative z-10 p-10">
      <div class="md:flex block gap-5 items-center h-full">
                ...
                <div class="flex items-center h-full">
                  <div class="bg-white rounded-full p-2 shadow shadow-piper-100">
                    <svg viewBox="0 0 16 16" class="w-7 fill-piper-600">
                      <g id="SVGRepo_iconCarrier">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M3.36066 4.98361H4.93443V7.86885H8.60656V9.44262H4.93443V13.1148H8.60656V14.6885H4.14754C3.71296 14.6885 3.36066 14.3362 3.36066 13.9016V4.98361Z">
                        </path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M1 1.83607C1 0.822034 1.82203 0 2.83607 0H10.7049C11.7189 0 12.541 0.822034 12.541 1.83607V3.67213C12.541 4.68616 11.7189 5.5082 10.7049 5.5082H2.83607C1.82203 5.5082 1 4.68616 1 3.67213V1.83607ZM2.83607 1.57377C2.6912 1.57377 2.57377 1.6912 2.57377 1.83607V3.67213C2.57377 3.81699 2.6912 3.93443 2.83607 3.93443H10.7049C10.8498 3.93443 10.9672 3.81699 10.9672 3.67213V1.83607C10.9672 1.6912 10.8498 1.57377 10.7049 1.57377H2.83607Z">
                        </path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M7.81967 8.39344C7.81967 7.37941 8.64171 6.55738 9.65574 6.55738H12.2787C13.2927 6.55738 14.1148 7.37941 14.1148 8.39344V8.91803C14.1148 9.93206 13.2927 10.7541 12.2787 10.7541H9.65574C8.64171 10.7541 7.81967 9.93206 7.81967 8.91803V8.39344ZM9.65574 8.13115C9.51088 8.13115 9.39344 8.24858 9.39344 8.39344V8.91803C9.39344 9.06289 9.51088 9.18033 9.65574 9.18033H12.2787C12.4235 9.18033 12.541 9.06289 12.541 8.91803V8.39344C12.541 8.24858 12.4235 8.13115 12.2787 8.13115H9.65574Z">
                        </path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M7.81967 13.6393C7.81967 12.6253 8.64171 11.8033 9.65574 11.8033H12.2787C13.2927 11.8033 14.1148 12.6253 14.1148 13.6393V14.1639C14.1148 15.178 13.2927 16 12.2787 16H9.65574C8.64171 16 7.81967 15.178 7.81967 14.1639V13.6393ZM9.65574 13.377C9.51088 13.377 9.39344 13.4945 9.39344 13.6393V14.1639C9.39344 14.3088 9.51088 14.4262 9.65574 14.4262H12.2787C12.4235 14.4262 12.541 14.3088 12.541 14.1639V13.6393C12.541 13.4945 12.4235 13.377 12.2787 13.377H9.65574Z">
                        </path>
                      </g>
                    </svg>
                  </div>
                ...
                <div class="flex items-center h-full">
                  <div class="bg-white rounded-full p-2 shadow shadow-piper-100">
                    <svg viewBox="0 0 197.667 197.667" class="w-7 fill-piper-600">
                      ...
                      <g id="SVGRepo_iconCarrier">
                        <path
                          d="M188.583,146.142v44.025c0,4.142-3.357,7.5-7.5,7.5h-164.5c-4.142,0-7.5-3.358-7.5-7.5v-44.025 c0-16.349,11.019-30.763,26.796-35.05l35.933-9.765c3.286-0.894,6.76,0.539,8.462,3.487l18.559,32.144l18.559-32.144 c1.702-2.948,5.18-4.378,8.462-3.487l35.933,9.765C177.564,115.379,188.583,129.792,188.583,146.142z M98.833,0 C77.722,0,60.547,20.479,60.547,45.652c0,25.172,17.175,45.652,38.287,45.652s38.286-20.479,38.286-45.652 C137.12,20.479,119.945,0,98.833,0z">
                        </path>
                      </g>
                    </svg>
                  </div>
        ...
        <div class="w-full h-full md:flex justify-center items-center py-5 hidden">
          <img class="rounded-full h-full aspect-square object-cover"
            src="https://d3i6fh83elv35t.cloudfront.net/static/2021/01/2021-01-04T004536Z_1887032542_MT1USATODAY15392993_RTRMADP_3_NCAA-BASKETBALL-OHIO-STATE-AT-MINNESOTA-1024x819.jpg"
            alt="" />
        </div>
      </div>
    </div>
      ...
      <div class="grid md:grid-cols-3 mt-5 gap-5 h-full">
        <div class="space-y-5 h-full">
          <div class="flex flex-col items-center justify-center">
            <div class="rounded-full h-28 w-28 bg-rhino-900 flex items-center justify-center">
              <svg class="fill-white w-15 h-15" viewBox="0 0 40 40">
                <g id="SVGRepo_iconCarrier">
                  <g display="none">
                    <path display="inline"
                  ...
                  <g>
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M20,29.616c-6.911,0-13.412-3.681-17-9.615c3.588-5.935,10.089-9.617,17-9.617 c6.91,0,13.412,3.682,17,9.617C33.412,25.936,26.91,29.616,20,29.616L20,29.616z M19.998,12.254 c-5.817,0-11.309,2.848-14.687,7.618l-0.088,0.125l0.088,0.124c3.378,4.77,8.87,7.618,14.687,7.618 c5.82,0,11.311-2.849,14.687-7.618l0.089-0.124l-0.089-0.125C31.309,15.103,25.818,12.254,19.998,12.254L19.998,12.254z">
                    </path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M19.987,13.521c-3.574,0-6.478,2.9-6.478,6.479c0,3.579,2.904,6.478,6.478,6.478 c3.581,0,6.478-2.898,6.478-6.478C26.465,16.42,23.568,13.521,19.987,13.521z M19.987,24.857c-2.68,0-4.858-2.175-4.858-4.858 s2.178-4.859,4.858-4.859c2.686,0,4.858,2.175,4.858,4.859S22.673,24.857,19.987,24.857z">
                    </path>
                  </g>
                </g>
              </svg>
          ...
          <div class="bg-white w-full min-h-20 md:h-full md:max-h-52 rounded-lg shadow-lg p-5">
            <p class="text-gray-600 text-sm font-comicsans">
              ...
              penting untuk menjaga keberlangsungan dan kemajuan olahraga ini.
            </p>
          </div>
        </div>
        <div class="space-y-5 h-full">
          <div class="flex flex-col items-center justify-center">
            <div class="rounded-full h-28 w-28 bg-rhino-900 flex items-center justify-center">
              <svg viewBox="0 0 32 32" class="stroke-white w-15 h-15">
                <g id="SVGRepo_iconCarrier">
                  <line class="fill-none stroke-2" x1="16" y1="16" x2="22" y2="10"></line>
                  <polygon class="fill-none stroke-2" points="30,6 26,6 26,2 22,6 22,10 26,10 "></polygon>
                  <circle class="fill-none stroke-2" cx="16" cy="16" r="6"></circle>
                  <path class="fill-none stroke-2"
          ...
          <div class="bg-white w-full min-h-20 md:h-full md:max-h-52 rounded-lg shadow-lg p-5">
            <p class="text-gray-600 text-sm font-comicsans">
              ...
              basket, tidak hanya untuk hari ini, tetapi juga untuk tahun-tahun mendatang.
            </p>
          </div>
        </div>
        <div class="space-y-5 h-full">
    ...
    <div class="w-full md:min-h-[calc(100vh-64px)] bg-gray-100 relative z-10 py-16 px-6">
      <div class="max-w-6xl mx-auto text-center">
        ...
        <Carousel :value="testimonials" :numVisible="3" :numScroll="1" :responsiveOptions="[
          { breakpoint: '1024px', numVisible: 2, numScroll: 1 },
          { breakpoint: '768px', numVisible: 1, numScroll: 1 },
        ]" autoplayInterval="5000" class="px-4" :show-navigators="false">
          <template #item="slotProps">
            <div class="pb-9 h-full">
              <div class="relative bg-white shadow-xl border border-gray-200 rounded-xl p-6 pt-16 h-full md:mx-3">
    ...
    <div class="w-full md:min-h-[calc(100vh-64px)] bg-noise relative z-10 p-10">
      <div class="max-w-6xl mx-auto text-center">
        ...
        <!-- Carousel Prestasi -->
        <Carousel :value="achievements" :numVisible="2" :numScroll="1" :responsiveOptions="[
          { breakpoint: '1024px', numVisible: 2, numScroll: 1 },
          { breakpoint: '768px', numVisible: 1, numScroll: 1 },
        ]" autoplayInterval="5000" class="px-2 sm:px-4" :show-navigators="false">
          <template #item="slotProps">
        ...
        <!-- Carousel Foto Prestasi -->
        <div class="mb-12">
          <Carousel :value="achievementPhotos" :numVisible="3" :numScroll="1" :responsiveOptions="[
            { breakpoint: '1024px', numVisible: 2, numScroll: 1 },
            { breakpoint: '768px', numVisible: 1, numScroll: 1 },
          ]" autoplayInterval="5000" class="px-2 sm:px-4" :show-navigators="false">
            <template #item="slotProps">
              <div class="pb-10 h-full">
                <div
                  class="relative group bg-white border border-gray-200 rounded-xl md:rounded-2xl p-4 shadow-md hover:shadow-xl transition duration-300 overflow-hidden text-center h-full flex flex-col mx-2 md:mx-3">
                  <div class="relative h-48 md:h-56 overflow-hidden rounded-lg mb-4">
                    ...
                    <div
                      ...
                      <p class="text-white text-sm font-medium">{{ slotProps.data.desc }}</p>
                    </div>
                  </div>
                  <h4 class="text-base md:text-lg font-bold text-rhino-900 mb-2">
                    {{ slotProps.data.title }}
                  </h4>
                </div>
              </div>
        ...
        <!-- Statistik Prestasi -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-12 max-w-4xl mx-auto">
          <div class="text-center bg-white rounded-xl p-4 shadow-md">
            <div class="text-2xl md:text-4xl font-bold text-piper-600 font-basketball">52</div>
            <div class="text-xs md:text-sm text-gray-600 mt-1">Tahun Pengalaman</div>
          </div>
          <div class="text-center bg-white rounded-xl p-4 shadow-md">
            <div class="text-2xl md:text-4xl font-bold text-piper-600 font-basketball">76</div>
            <div class="text-xs md:text-sm text-gray-600 mt-1">Trofi 2023</div>
          </div>
          <div class="text-center bg-white rounded-xl p-4 shadow-md">
            <div class="text-2xl md:text-4xl font-bold text-piper-600 font-basketball">7</div>
            <div class="text-xs md:text-sm text-gray-600 mt-1">Kelas Umur</div>
          </div>
          <div class="text-center bg-white rounded-xl p-4 shadow-md">
            <div class="text-2xl md:text-4xl font-bold text-piper-600 font-basketball">4</div>
            <div class="text-xs md:text-sm text-gray-600 mt-1">Pelatih</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="max-w-7xl mx-auto text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div
            ...
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="Gallery 1"
              class="w-full h-80 object-cover" />
          </div>
          <div
            class="overflow-hidden rounded-xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="Gallery 2"
              class="w-full h-80 object-cover" />
          </div>
          <div
            class="overflow-hidden rounded-xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="Gallery 3"
              class="w-full h-80 object-cover" />
          </div>
          <div
            class="overflow-hidden rounded-xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="Gallery 4"
              class="w-full h-80 object-cover" />
          </div>
          <div
            class="overflow-hidden rounded-xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="Gallery 5"
              class="w-full h-80 object-cover" />
          </div>
          <div
            class="overflow-hidden rounded-xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="Gallery 6"
              class="w-full h-80 object-cover" />
          </div>
        </div>
      </div>
      ...
      <div class="max-w-7xl mx-auto text-center">
        ...
        <div class="grid md:grid-cols-3 gap-12">
          <div class="flex flex-col items-center text-center">
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="KU 8-12"
          ...
          <div class="flex flex-col items-center text-center">
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="KU 14-16"
              class="w-48 h-48 object-cover rounded-full shadow-lg mb-6" />
          ...
          <div class="flex flex-col items-center text-center">
            <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" alt="KU 18 Divisi 2"
              class="w-48 h-48 object-cover rounded-full shadow-lg mb-6" />
    ...
    <div class="w-full bg-gray-50 relative z-10 py-20 px-6">
      <div class="max-w-6xl mx-auto text-center">
        ...
        <p class="text-gray-600 mb-12 font-comicsans max-w-2xl mx-auto">
          Pertanyaan yang sering diajukan tentang bergabung dengan Victoria Basketball Club
        </p>

        <div class="grid md:grid-cols-1 gap-6 max-w-4xl mx-auto text-left">
          <!-- FAQ Item 1 -->
          <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
            <button @click="toggleFAQ(0)"
              class="flex justify-between items-center w-full p-6 text-left hover:bg-gray-50 transition-colors duration-200">
              <span class="font-bold text-rhino-900 text-lg">
                Apa saja syarat bergabung dengan Victoria Basket?
              </span>
              <svg :class="{ 'rotate-180': activeFAQ === 0 }"
                class="w-5 h-5 text-piper-600 transition-transform duration-300" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            <div v-show="activeFAQ === 0" class="px-6 pb-6 text-gray-700 font-comicsans transition-all duration-300">
              <p class="mb-3">
                Siapapun yang minat berolahraga basket, dari yang sekedar cari keringat dan cari kawan, hingga mengejar
                prestasi lebih jauh.
              </p>
              <p class="mb-3">
                Tidak ada syarat khusus, cukup siapkan sepatu basket, baju dan celana olahraga, untuk trial gratis
                dengan
                kami.
              </p>
              <p class="mb-3">
                Silakan datang ke "tempat latihan" di "hari dan jam latihan" kami yang sesuai dengan kategori usia Anda.
              </p>
              <p>
                Kelengkapan administrasi dan iuran yang diperlukan dapat dilakukan setelah trial, dan Anda memutuskan
                bergabung dengan kami Victoria basket.
              </p>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
            <button @click="toggleFAQ(1)"
              class="flex justify-between items-center w-full p-6 text-left hover:bg-gray-50 transition-colors duration-200">
              <span class="font-bold text-rhino-900 text-lg">
                Berapa iuran dan dokumen untuk bergabung dengan Victoria Basket?
              </span>
              <svg :class="{ 'rotate-180': activeFAQ === 1 }"
                class="w-5 h-5 text-piper-600 transition-transform duration-300" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            <div v-show="activeFAQ === 1" class="px-6 pb-6 text-gray-700 font-comicsans transition-all duration-300">
              <p class="font-semibold text-piper-600 mb-2">Iuran-iuran wajib:</p>
              <ul class="list-disc pl-5 mb-4 space-y-1">
                <li>Beaya pendaftaran: <span class="font-semibold">Rp. 400.000</span> (empat ratus ribu rupiah) - sekali
                  bayar</li>
                <li>Iuran bulanan: <span class="font-semibold">Rp. 350.000</span> (tiga ratus lima puluh ribu rupiah) -
                  per
                  bulan</li>
              </ul>
              <p class="mb-4 text-sm italic">
                Biaya dan iuran tersebut adalah untuk menunjang kegiatan latihan rutin bulanan, di luar kebutuhan lain
                yang
                sifatnya tidak wajib.
              </p>

              <p class="font-semibold text-piper-600 mb-2">Dokumen pelengkap:</p>
              <ul class="list-disc pl-5 space-y-1">
                <li>Fotokopi akte keluarga</li>
          ...
          <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
            <button @click="toggleFAQ(2)"
              class="flex justify-between items-center w-full p-6 text-left hover:bg-gray-50 transition-colors duration-200">
              <span class="font-bold text-rhino-900 text-lg">
                Berapa usia minimal atau maksimal untuk bergabung dengan Victoria Basket?
              </span>
              <svg :class="{ 'rotate-180': activeFAQ === 2 }"
                class="w-5 h-5 text-piper-600 transition-transform duration-300" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            <div v-show="activeFAQ === 2" class="px-6 pb-6 text-gray-700 font-comicsans transition-all duration-300">
              <p class="mb-3">
                Silakan lihat kategori "kelompok umur" sesuai dengan kategori pembinaan Perbasi.
              </p>
              <p class="mb-3">
                Untuk usia minimal, kami menyarankan usia <span class="font-semibold">7 tahun</span> untuk mulai
                bergabung
                dengan kami.
              </p>
              <p>
                Untuk usia maksimal, siapapun yang masih berminat silakan bergabung dengan kami. Untuk usia di atas 18
                tahun, bisa bergabung dengan kawan-kawan Senior Divisi 2 (baik putera maupun puteri) yang rutin berlatih
                setiap hari Jumat malam.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="w-full md:min-h-[calc(100vh-64px)] bg-noise relative z-10 p-10">
      <div class="max-w-7xl mx-auto text-center">
        ...
        <Carousel :value="sponsorships" :numVisible="4" :numScroll="1" :responsiveOptions="[
          { breakpoint: '1024px', numVisible: 3, numScroll: 1 },
          { breakpoint: '768px', numVisible: 2, numScroll: 1 },
          { breakpoint: '480px', numVisible: 1, numScroll: 1 }
        ]" autoplayInterval="4000" class="px-2 sm:px-4 mt-10" :show-navigators="false">
          <template #item="slotProps">
            <div class="pb-10 h-full">
              <div
                class="relative group bg-white border border-gray-200 rounded-xl md:rounded-2xl p-4 shadow-md hover:shadow-xl transition duration-300 overflow-hidden flex flex-col items-center justify-center mx-2 md:mx-3">
                <div class="relative h-32 md:h-40 w-full flex items-center justify-center overflow-hidden mb-4">
                  <img :src="slotProps.data.image" :alt="slotProps.data.name"
                    class="w-auto h-full object-contain transition-transform duration-500 group-hover:scale-105" />
                </div>
                <h4 class="text-base md:text-lg font-bold text-rhino-900 font-basketball">
                  {{ slotProps.data.name }}
                </h4>
              </div>
            </div>
          ...
          <div class="md:w-5/12 w-full md:space-y-5 space-y-3">
            ...
            <div class="flex items-start gap-5">
              <div
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 md:w-5 md:h-5" fill="currentColor"
                  viewBox="0 0 24 24">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 
            ...
            <form class="bg-white shadow-md rounded-xl p-6 space-y-4 border border-gray-100 w-full">
              ...
              <div>
                ...
                <textarea rows="4" placeholder="Tulis pesan anda..."
                  class="w-full rounded-xl border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:ring-2 focus:ring-piper-600 focus:outline-none transition text-sm"></textarea>
              </div>
              <button type="submit"

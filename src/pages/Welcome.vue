...
<template>
        ...
        <div class="h-full w-full flex md:justify-end justify-center items-center gap-3 px-10">
          ...
          <div>
            <div class="flex bg-white border border-gray-400 shadow-lg rounded-lg overflow-hidden">
              ...
              <input
                class="bg-white text-black px-2 py-1 text-sm focus:outline-0"
                type="text"
                placeholder="Cari...."
              />
            </div>
    ...
    <div class="w-full md:h-[calc(100vh-64px)] bg-gray-100 relative z-10 p-10">
      <div class="md:flex block gap-5 items-center h-full">
        ...
        <div class="w-full h-full md:flex justify-center items-center py-5 hidden">
          <img
            class="rounded-full h-full aspect-square object-cover"
  ...
  <!-- Section 5 - Testimoni -->
  <div class="w-full md:h-[calc(100vh-64px)] bg-gray-100 relative z-10 py-16 px-6">
    <div class="max-w-6xl mx-auto text-center">
      ...
      >
        <template #item="slotProps">
          <div class="relative bg-white shadow-xl border border-gray-200 rounded-xl p-6 pt-16 mx-3">
  ...
  <div class="max-w-6xl mx-auto text-center">
    ...
    >
      <template #item="slotProps">
        ...
        >
          <div class="absolute inset-0 rounded-xl sm:rounded-2xl border-2 border-transparent bg-gradient-to-r from-piper-400/20 to-piper-600/20 opacity-0 group-hover:opacity-100 transition"></div>
          ...
          <div class="relative flex items-start gap-4 sm:gap-6">
            ...
            />
            <div>
              <h3 class="text-lg sm:text-2xl font-bold text-rhino-900 flex items-center gap-2 sm:gap-3">
...
<div class="w-full bg-gray-50 relative z-10 py-20 px-6">
  <div class="max-w-7xl mx-auto text-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
      ...
      <div class="overflow-hidden rounded-xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
        <img src="https://i.pinimg.com/1200x/33/9b/93/339b93c062180b34101b488ab3a149eb.jpg" 
             alt="Gallery 1" 
...
<div class="w-full min-h-screen bg-gray-100 relative z-10 py-16 px-4 sm:px-6 lg:px-8 pb-24">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="text-center mb-12">
      <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-rhino-900 font-basketball">
        Hubungi Kami
      </h2>
    ...
    <div class="flex flex-col md:flex-row md:justify-between gap-y-12 md:gap-x-12 items-start">
      <div class="md:w-5/12 space-y-10">
        <div class="flex items-start gap-5">
          <div class="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#CC6633]/10 text-piper-600 flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 sm:w-7 sm:h-7" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex items-start gap-5">
          <div class="flex items-center justify-center w-12 h-12 rounded-full bg-[#CC6633]/10 text-piper-600 flex-shrink-0">

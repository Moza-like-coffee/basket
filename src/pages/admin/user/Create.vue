          ...
          <fieldset class="border border-gray-300 rounded-lg shadow p-5">
            ...
            <div class="grid grid-cols-2 gap-3">
              <div class="space-y-1">
                ...
                <input id="name" type="text" v-model="form.name" placeholder="Masukkan Nama Lengkap"
              ...
              <div class="space-y-1">
                ...
                <input id="username" type="text" v-model="form.username" placeholder="Masukkan Username"
                  class="px-2.5 py-2 border border-gray-300 rounded-lg shadow text-sm w-full focus:outline-1 focus:outline-gray-500"
                  required />
              </div>

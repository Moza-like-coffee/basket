...
async function fetchData() {
  try {
    ...
    if (!selectedMember.value) {
      responseStore.addError('Data anak tidak ditemukan')
    ...
    responseStore.addError('Gagal memuat data')
  }
}
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-4 mt-2 text-sm text-gray-600">
              <span class="flex items-center gap-2">
                ...
                Usia:
                {{ selectedMember ? calculateAgeGroup(selectedMember.date_of_birth) : '' }} tahun
              </span>
              <span class="flex items-center gap-2">
